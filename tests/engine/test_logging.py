...
from coding_agent.engine.logging import EventType, RunEvent, RunEventLogger, RunLogError
...
def test_auto_run_id_collision_retries_sixteen_times_then_fails(
    ...
    monkeypatch.setattr("coding_agent.engine.logging.uuid.uuid4", repeated_uuid)
