...
import coding_agent.engine.agent as agent_module
from coding_agent.engine.agent import AgentInterrupted, AgentRunner
...
from coding_agent.engine.progress import AgentPhase, ProgressLimits
...
from coding_agent.engine.verification import VerificationGate, VerificationResult
...
import coding_agent.engine.agent
import coding_agent.engine.state
import coding_agent.operations.tools.base
import coding_agent.operations.tools.registry
"""
...
def test_registry_distinguishes_stable_safety_rejection(tmp_path: Path) -> None:
    class SafetyRejectingTool:
        ...
        def execute(
            ...
            from coding_agent.operations.safety import SafetyCode, SafetyViolation
