...
def test_sse_connection_limit_rejects_first_disallowed_per_run() -> None:
    from coding_agent.web.app import _SseConnectionLimiter, WebStreamLimitError
...
def test_sse_permit_close_is_thread_safe_and_idempotent(
    ...
    import coding_agent.web.app as web_module
    from coding_agent.web.app import _SseConnectionLimiter, _SsePermit
...
def test_sse_disconnect_generator_close_releases_without_cancelling() -> None:
    from coding_agent.web.app import _SseConnectionLimiter, _sse_stream
