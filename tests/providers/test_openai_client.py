...
from coding_agent.providers.openai_client import (
...
def test_constructor_disables_sdk_retries_and_does_not_store_key(
    ...
    monkeypatch.setattr("coding_agent.providers.openai_client.OpenAI", factory)
    client = OpenAIResponsesClient(
        model=" gpt-test ",
        api_key=FAKE_KEY,
        sleeper=lambda delay: None,
...
from coding_agent.engine.messages import ModelRequest, UserMessage
