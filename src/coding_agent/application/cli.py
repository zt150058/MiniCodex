...
from coding_agent.application.config import ConfigError, load_run_config
from coding_agent.engine.run_mode import RunMode

if TYPE_CHECKING:
    from coding_agent.application.app import Application
...
def main(
    ...
    *,
    ...
    if application is None:
        from coding_agent.application.app import run_application
